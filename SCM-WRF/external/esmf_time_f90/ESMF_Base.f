...
!------------------------------------------------------------------------------
      ...
      private
          ...
          ! in C++ id do a union w/ overloaded access funcs
          integer :: vi
...
!------------------------------------------------------------------------------
! function to compare two ESMF_Status flags to see if theyre the same or not
...
!------------------------------------------------------------------------------
! function to compare two ESMF_DataTypes to see if theyre the same or not
...
!------------------------------------------------------------------------------
! function to compare two ESMF_Pointers to see if theyre the same or not
...
!------------------------------------------------------------------------------
! function to compare two ESMF_Logicals to see if theyre the same or not
...
!------------------------------------------------------------------------------
! function to compare two ESMF_AxisIndex to see if theyre the same or not
...
!BOP
!
! !IROUTINE:  ESMF_AttributeGetCount - get an ESMF objects number of attributes
!
! !INTERFACE:
...
!BOP
!
! !IROUTINE:  ESMF_AttributeGetbyNumber - get an ESMF objects attribute by num ber
!
! !INTERFACE:
...
!BOP
!
!IROUTINE:  ESMF_AttributeGetNameList - get an ESMF objects attribute name list
!
! !INTERFACE:
...
!BOP
!
! !IROUTINE:  ESMF_AttributeSetList - set an ESMF objects attributes 
!
! !INTERFACE:
...
!BOP
!
! !IROUTINE:  ESMF_AttributeGetList - get an ESMF objects attributes
!
! !INTERFACE:
...
! {\tt read only} and wont be updated by this call.  (e.g. an attribute
! like {\tt name} must be unique and therefore cant be duplicated.)
